...
#   good_reviews = Review.new(booking: Booking.all.sample rating: rand(4..5), content: content.sample)
#   good_reviews.save!
...
#   bad_reviews = Review.new(booking: Booking.all.sample, rating: rand(1..3), content: bad_reviews.sample)
#   bad_reviews.save!
# end
